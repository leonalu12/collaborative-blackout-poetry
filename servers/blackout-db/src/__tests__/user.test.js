...
describe('User API CRUD', () => {
  ...
  it('should return all users', async () => {
    await User.create({ name: 'Ana', email: 'ana@example.com' });
  ...
  it('should return a user by ID', async () => {
    const created = await User.create({ name: 'Carlos', email: 'carlos@example.com' });
  ...
  it('should update a user', async () => {
    const created = await User.create({ name: 'Test User', email: 'test@example.com' });
  ...
  it('should delete a user', async () => {
    const created = await User.create({ name: 'Delete Me', email: 'delete@example.com' });
